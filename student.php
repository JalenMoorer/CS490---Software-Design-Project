                ...
                <div class="col-md-6">
                    <div id="instructions" class="intro-message">
                        ...
                        <form id="showallexams">
                            ...
                            <small>Exams will be posted here by your instructor</small></h1>
                            <h2><h2>
                            <small>Welcome to the student exam portal.  Here you can take exams that are offered by your instructor.  The exams will be waiting here after publishing until they expire, so do not wait too long to take them!</small>
                        </div>
                        <div class="well">
                            <h1>Tips</h1>
                            <ul>
                                <li>It is recommended that you finish an exam as early as possible, to avoid last minute rushing</li>
                                <li>Each exam can only be attempted<span class="text-danger"><b> once!</b></span></li>
                                <li><span class="text-danger">Once an exam expires, you are no longer able to take them</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
